...
if (amysBirthYear === brittanisBirthYear) {
  console.log('Amy and Brittani share the same birth year')
} else {
  console.log('Amy and Brittani do not share the same birth year')
}
